...
const Button = React.forwardRef((props, ref) => {
  ...
  const classes = {
    ...
    variant: {
      primary:
        "border-red-700 bg-red-700 text-white hover:text-white hover:bg-red-800 hover:border-blue-800 focus:ring-blue-500 focus:ring-opacity-50 active:bg-blue-700 active:border-blue-700",
      secondary:
